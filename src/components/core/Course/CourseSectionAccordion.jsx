...
const CourseSectionAccordion = ({
  ...
  return (
    <div className="border border-solid  border-[#424854] text-[#F1F2FF] overflow-hidden">
      <div
        className="bg-[#2C333F] flex justify-between items-center cursor-pointer px-7 py-6 "
      ...
      <div
        ref={sectionsDiv}
        className="bg-[#000814] h-0 translate-all duration-[0.35s] ease-[ease] overflow-hidden"
