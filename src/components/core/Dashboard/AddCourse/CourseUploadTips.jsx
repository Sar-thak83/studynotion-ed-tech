...
const CourseUploadTips = () => {
  return (
    <div className="sticky lg:block top-10 max-w-[400px] flex-1 rounded-md border border-[#2C333F] bg-[#161D29] p-6 ">
      <p className="text-lg text-[#F1F2FF] mb-8">⚡ Course Upload Tips</p>
