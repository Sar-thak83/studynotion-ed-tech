...
const ChipInput = ({
  ...
  return (
    <div className="flex flex-col">
      <label htmlFor={"chip"} className="mb-[8px] text-[14px] text-[#F1F2FF]">
      ...
      <div className="flex flex-wrap gap-y-1 mb-2">
        {chips.map((chip, ind) => (
          <div
            key={ind}
            className="flex items-center gap-x-2 bg-[#9E8006] rounded-full px-2 py-1 text-sm text-[#F1F2FF] m-1 "
          >
            {chip}

            <button
              type="button"
              className=" hover:outline outline-[#2C333F] rounded-full"
