...
const Sidebar = () => {
  ...
  return (
    <div className="bg-[#161D29] ">
      <div className="flex flex-col w-fit md:min-w-[220px] min-h-[calc(100vh-3.5rem)] border-r border-[#2C333F] py-10">
        ...
        <div className="mx-auto my-6 h-[1px] w-10/12 bg-[#2C333F]"></div>
        ...
        <div>
          <button
            ...
            className="flex gap-x-2 items-center text-sm font-medium px-3 md:px-8 py-2 text-[#838894]"
          >
