        ...
        <div className="mt-5 md:mt-0 px-1 md:px-6 flex-1 h-full w-full overflow-x-auto">
          <div className=" flex flex-col gap-5 w-full">
                      ...
                      <div className="h-[44px]">
                        {!isLastVideo() && (
                          <button
                            ...
                            className="bg-[#25239c] text-[#F1F2FF] font-semibold text-lg px-5 py-2 flex items-center gap-x-2 rounded-md"
                          >
                            Next
                            <BiChevronRight />
                          </button>
            ...
            <div className="text-[#F1F2FF]">
              <p className=" text-[#DBDDEA] mb-2 text-2xl font-semibold">
                {subSection.title}
              </p>

              <p className="pb-6 text-[#AFB2BF]">{subSection.description}</p>
            </div>
          </div>
        </div>
      )}
