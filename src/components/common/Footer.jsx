  ...
  return (
    <div className="bg-[#161D29]">
      <div className="flex flex-col  text-white w-11/12 max-w-maxContent mx-auto pt-14">
        {/* Upper Section */}
        <div className="flex flex-col lg:flex-row border-b border-[#2C333F] pb-5">
          {/* left section */}
        ...
        {/* Bottom section */}
        <div className="flex flex-col lg:flex-row justify-between items-center text-[#6E727F] text-sm py-14">
          <div className="flex flex-row">
            {BottomFooter.map((ele, ind) => {
              return (
                <Link to={ele.split(" ").join("-").toLowerCase()} key={ind}>
                  <div
                    className={`cursor-pointer hover:text-[#C5C7D4] transition-all duration-200 px-3 
                                ${
          ...
          <div className="text-center">
            Made with ❤️ Sarthak © 2025 StudyNotion
          </div>
        </div>
      </div>
    </div>
