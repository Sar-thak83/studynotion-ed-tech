...
const Home = () => {
  ...
  return (
    <div className=" bg-[#000814] flex flex-col font-inter min-h-screen w-screen">
      ...
      <div className="bg-[#000814]">
        <div className=" relative mx-auto flex flex-col items-center justify-between  w-11/12 max-w-maxContent text-white gap-8">
          <div className="rounded-full bg-[#161D29] text-[#999DAA] mt-16 p-1 mx-auto w-fit drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] group transition-all duration-200 hover:scale-95 hover:drop-shadow-none ">
            <Link to={"/signup"}>
              <div className=" flex flex-row items-center gap-2 font-bold rounded-full px-10 py-[5px] transition-all duration-200 group-hover:bg-[#000814] ">
          ...
          <div className="-mt-3 w-11/12 text-center text-lg text-[#838894] font-bold">
            <p className="">
          ...
          <div className="mx-3 my-7 transition-all duration-200 shadow-[10px_-5px_50px_-5px] shadow-[#118AB2]">
            <video
              className="drop-shadow-[20px_20px_rgba(255,255,255)] rounded-md"
              muted
              loop
              autoPlay
              src={Banner}
