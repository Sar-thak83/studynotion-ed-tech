...
const CourseDetails = () => {
  ...
  const handleBuyNowClick = async () => {
    ...
    if (user && courseData.studentsEnrolled.includes(user._id)) {
      ...
      navigate(
        `/view-course/${courseData._id}/section/${courseData.sections[0]._id}/sub-section/${courseData.sections[0].subSections[0]._id}`
      );
      return;
    }
  ...
  return (
    <div className="bg-[#000814]">
      ...
      {!loading && !courseData && (
        <div className="grid place-items-center min-h-[calc(100vh-3.5rem)]">
          <p className="text-xl text-center text-[#F1F2FF]">
      ...
      {!loading && courseData && (
        <div className="bg-[#000814] text-[#F1F2FF]">
          <div className="bg-[#161D29] text-[#F1F2FF] ">
            {/* Course Details */}
            <div className="mx-auto px-4 py-8 lg:w-[1260px] min-h-[450px]  2xl:relative">
              <div className="mx-auto lg:mx-0 flex flex-col items-center lg:items-start max-w-maxContentTab xl:max-w-[810px]">
                <p className="text-sm w-full ml-5 lg:ml-0 text-left text-[#838894]">
                  Home / Learning /{" "}
                ...
                <div className="flex flex-col justify-center gap-4 py-5 text-lg text-[#F1F2FF] my-5">
                  <p className="text-3xl sm:text-4xl font-bold text-[#F1F2FF] ">
                    {courseData.title}
                  </p>
                  <p className="text-[#999DAA]">{courseData.description}</p>

                  <div className="flex items-center flex-wrap gap-2 text-md">
                    <p className="text-[#FFE83D]">{courseData.averageRating}</p>
                    ...
                    <p className="text-[#999DAA]">
                      ( {courseData.reviews.length} ratings ){" "}
                    </p>
                    <p className="text-[#999DAA]">
                      {courseData.numberOfEnrolledStudents} students
                    </p>
                  </div>
                ...
                <div className="lg:hidden w-full flex flex-col gap-4 border-y border-y-[#585D69] py-4 ">
                  <p className="pb-4 text-3xl font-semibold text-[#F1F2FF] text-center">
                    ₹ {courseData.price}
                  </p>
          ...
          <div className="bg-[#000814] text-[#F1F2FF]">
            <div className="px-4 lg:w-[1260px] mx-auto">
              <div className="mx-auto lg:mx-0 max-w-maxContentTab xl:max-w-[810px]">
                {/* What you will learn */}
                <div className="border border-[#424854] my-8 p-8">
                ...
                <div className="max-w-[830px]">
                  <div className="flex flex-col gap-y-3">
                    ...
                    <div className="flex flex-wrap justify-between gap-2">
                      <div className="flex gap-1 text-sm text-[#999DAA]">
